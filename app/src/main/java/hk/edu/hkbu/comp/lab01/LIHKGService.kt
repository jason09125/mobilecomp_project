...
interface LIHKGService {
    ...
    @GET("/api_v2/thread/latest/page/{page}")
    fun getLatestThread(@Path("page") page: String = "1", @Query("cat_id") cat_id: Int = 1): Call<Response<ThreadList>>

    @GET("/api_v2/thread/hot/page/{page}")
    fun getHotPost(@Path("thread_id") threadId: String, @Path("page") page: String): Call<Response<ThreadList>>
